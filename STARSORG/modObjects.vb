Module modObjects
    Public Sub ClearScreenControls(ByVal objContainer As Control)
        'This procedure will clear all controls on the container passed as the argument
        'Not all control types have been implemented. Add as you need them.
        Dim obj As Control
        ...
        For Each obj In objContainer.Controls
            ...
            Select Case strControlType
                ...
                Case Else
                    'do nothing or add some error trapping as needed 
            End Select
        Next
    End Sub
End Module
